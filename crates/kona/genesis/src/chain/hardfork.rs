...
impl Display for HardForkConfig {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        ...
        writeln!(
            ...
            fmt_time(self.isthmus_time)
        )?;
        writeln!(
            f,
            "-> Interop Activation Time: {}",
            fmt_time(self.interop_time)
        )
    }
}
