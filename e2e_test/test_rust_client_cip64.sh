...
# Fund a fresh throwaway account so nonce filling is exercised from zero and the fee is
# provably paid in the fee currency (the account's CELO stays untouched aside from VALUE).
