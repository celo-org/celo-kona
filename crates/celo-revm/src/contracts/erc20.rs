    ...
    DB: Database,
{
    ...
    let calldata = IFeeCurrencyERC20::balanceOfCall { account }.abi_encode().into();
...
mod tests {
    ...
    fn test_encode_balance_of() {
        ...
        assert_eq!(&calldata[expected_address_offset..expected_address_offset + 20], account.as_slice());
    }
    ...
    fn test_decode_balance_of() {
        ...
        let decoded = IFeeCurrencyERC20::balanceOfCall::abi_decode_returns(&return_data)
            .unwrap();
