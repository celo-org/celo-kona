...
/// Mainnet FeeCurrencyDirectory; matches `get_addresses(42220)` in celo-revm.
const TEST_FCD: Address = address!("15F344b9E6c3Cb6F0376A36A64928b13F62C6276");

/// Build an `InMemoryDB` with a MockOracle (rate 1 FC = 10 native), the mainnet
/// FeeCurrencyDirectory, an ERC20 fee currency at `TEST_FC`, and a sender
/// pre-funded with native CELO + FC tokens.
fn make_celo_test_db(sender: Address, fc_balance: U256) -> InMemoryDB {
    // Bytecode lifted from celo-revm/src/contracts/core_contracts.rs (test helpers).
    const ORACLE_BYTECODE: &[u8] = &hex!(
        ""
    );
    const FCD_BYTECODE: &[u8] = &hex!(
        ""
    );
    const FC_BYTECODE: &[u8] = &hex!(
    ...
    // ── MockOracle: numerator slot 0 = 1, denominator slot 1 = 10 (1 FC = 10 native)
    let oracle_code = Bytecode::new_raw(ORACLE_BYTECODE.into());
    db.insert_account_info(
        TEST_ORACLE,
        AccountInfo {
            balance: U256::ZERO,
            nonce: 0,
            code_hash: oracle_code.hash_slow(),
            account_id: None,
            code: Some(oracle_code),
        },
    );
    db.insert_account_storage(TEST_ORACLE, U256::from(0), U256::from(1)).unwrap(); // num
    db.insert_account_storage(TEST_ORACLE, U256::from(1), U256::from(10)).unwrap(); // denom
    db.insert_account_storage(TEST_ORACLE, U256::from(3), TEST_FC.into_word().into()).unwrap();

    // ── FeeCurrencyDirectory: registers TEST_FC → TEST_ORACLE with 50_000 intrinsic gas.
    let fcd_code = Bytecode::new_raw(FCD_BYTECODE.into());
    db.insert_account_info(
        TEST_FCD,
        AccountInfo {
            balance: U256::ZERO,
            nonce: 0,
            code_hash: fcd_code.hash_slow(),
            account_id: None,
            code: Some(fcd_code),
        },
    );
    // currencies array: length=1 at slot 2, [0] = TEST_FC at keccak(2).
    db.insert_account_storage(TEST_FCD, U256::from(2), U256::from(1)).unwrap();
    let arr_start = U256::from_be_bytes(keccak256(U256::from(2).to_be_bytes::<32>()).0);
    db.insert_account_storage(TEST_FCD, arr_start, TEST_FC.into_word().into()).unwrap();
    // currencyConfig[TEST_FC] at keccak(TEST_FC . 1): {oracle: TEST_ORACLE, intrinsicGas: 50_000}
    let mut buf = [0u8; 64];
    buf[12..32].copy_from_slice(TEST_FC.as_slice());
    buf[63] = 1;
    let cfg_slot = U256::from_be_bytes(keccak256(buf).0);
    db.insert_account_storage(TEST_FCD, cfg_slot, TEST_ORACLE.into_word().into()).unwrap();
    db.insert_account_storage(TEST_FCD, cfg_slot + U256::from(1), U256::from(50_000)).unwrap();

    // ── FC ERC20: balances[sender] = fc_balance, totalSupply = fc_balance.
    let fc_code = Bytecode::new_raw(FC_BYTECODE.into());
    db.insert_account_info(
        TEST_FC,
        AccountInfo {
            balance: U256::ZERO,
            nonce: 0,
            code_hash: fc_code.hash_slow(),
            account_id: None,
            code: Some(fc_code),
        },
    );
    let mut bal_buf = [0u8; 64];
    bal_buf[12..32].copy_from_slice(sender.as_slice());
    let bal_slot = U256::from_be_bytes(keccak256(bal_buf).0);
    db.insert_account_storage(TEST_FC, bal_slot, fc_balance).unwrap();
    db.insert_account_storage(TEST_FC, U256::from(2), fc_balance).unwrap();

    // ── Sender: pre-funded with native CELO for `value` transfers.
    db.insert_account_info(
        sender,
        AccountInfo {
...
/// Build the usual Celo test state, but replace the fee currency with a stub that answers
/// `balanceOf` with `type(uint256).max` and reverts on the larger `debitGasFees` calldata.
fn make_debit_reverting_celo_test_db(sender: Address) -> InMemoryDB {
    let mut db = make_celo_test_db(sender, U256::MAX);
    let code = Bytecode::new_raw(Bytes::from_static(&[
        0x60, 0x24, 0x36, 0x11, 0x60, 0x12, 0x57, // calldata size > 36: jump to revert
        0x60, 0x00, 0x19, 0x60, 0x00, 0x52, // mstore(0, type(uint256).max)
        0x60, 0x20, 0x60, 0x00, 0xf3, // return(0, 32)
        0x5b, 0x60, 0x00, 0x60, 0x00, 0xfd, // revert(0, 0)
    ]));
    db.insert_account_info(
        TEST_FC,
        AccountInfo {
...
fn explicit_payload_records_revert_eviction(no_tx_pool: bool) -> bool {
    ...
    let generation = PayloadGeneration::new(parent.number, parent.hash());
    ...
    failure_policies.set_canonical_head(generation);
...
fn pending_block_builder_does_not_record_revert_eviction() {
    let (sender, envelope, encoded, _tx_hash) = underfunded_cip64();
    let inner_db = make_celo_test_db(sender, U256::ZERO);
    let mut state = State::builder().with_database(inner_db).with_bundle_update().build();
    let chain_spec: Arc<OpChainSpec> = Arc::new(
        OpChainSpecBuilder::default()
    ...
    let pending_env = <NextEnv as BuildPendingEnv<Header>>::build_pending_env(&parent, None);
...
fn tx_pool_payload_records_revert_eviction() {
    ...
    let inner_db = make_debit_reverting_celo_test_db(sender);
    let mut state = State::builder().with_database(inner_db).with_bundle_update().build();
    let chain_spec: Arc<OpChainSpec> = Arc::new(
        OpChainSpecBuilder::default()
            .chain(Chain::from_id(42220))
    ...
    ctx.execute_best_transactions(
        &mut info,
        &mut builder,
        RethPayloadTransactions(OneTx(Some(pool_tx))),
        None,
        None,
    )
