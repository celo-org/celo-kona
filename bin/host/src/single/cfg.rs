...
use kona_host::{
    DataFormat, DirectoryKeyValueStore, DiskKeyValueStore, MemoryKeyValueStore,
...
impl CeloSingleChainHost {
    ...
    /// reader instead would yield a [`kona_genesis::RollupConfig`] and drop those fields.
    ///
    ...
    /// included) rather than the upstream [`kona_genesis::RollupConfig`]. The split-store wiring
