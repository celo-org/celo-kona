...
mod tests {
    ...
    fn test_revm_spec_id() {
        ...
        let mut config = CeloRollupConfig(RollupConfig {
    ...
    fn test_regolith_active() {
        let mut config = CeloRollupConfig(RollupConfig::default());
    ...
    fn test_max_sequencer_drift() {
        let mut config =
            CeloRollupConfig(RollupConfig { max_sequencer_drift: 100, ..Default::default() });
