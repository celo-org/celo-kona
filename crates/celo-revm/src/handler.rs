...
use crate::{CeloContext, constants::get_addresses, transaction::CeloTxTr};
use op_revm::{
    ...
    fn validate_against_state_and_deduct_caller(
        ...
        if is_balance_check_disabled {
            ...
            if !fees_in_celo {
                ...
                if fee_currency_context.currency_exchange_rate(fee_currency).is_err() {
                    return Err(ERROR::from_string("unregistered fee-currency address".to_string()));
                }
                ...
                return Err(ERROR::from_string("CIP-64 balance validation requires implementation of EVM type casting".to_string()));
            } else {
