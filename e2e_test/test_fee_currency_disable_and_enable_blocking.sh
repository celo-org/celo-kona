...
tail -F -n0 celo-reth.log >debug-fee-currency/reth.disable_and_enable_blocking.log & # start log capture
...
if [ "$(grep -Ec "fee-currency debit/credit halted" debug-fee-currency/reth.disable_and_enable_blocking.log)" -ne 1 ]; then exit 1; fi
