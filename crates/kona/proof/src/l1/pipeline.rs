...
use kona_derive::{
    ...
    prelude::StatefulAttributesBuilder,
    traits::{
...
use kona_proof::{FlushableCache, l1::ProviderDerivationPipeline};
use kona_protocol::{BlockInfo, L2BlockInfo, OpAttributesWithParent};
use spin::RwLock;

/// An oracle-backed derivation pipeline.
// pub type CeloProviderDerivationPipeline<L1, L2, DA> =
//     DerivationPipeline<AttributesQueueStage<DA, L1, L2, CeloProviderAttributesBuilder<L1, L2>>,
// L2>;

// /// An oracle-backed payload attributes builder for the `AttributesQueue` stage of the derivation
// /// pipeline.
// pub type CeloProviderAttributesBuilder<L1, L2> = StatefulAttributesBuilder<L1, L2>;
...
where
    ...
    L1: ChainProvider + CeloChainProvider + Send + Sync + Debug + Clone,
    ...
    DA: DataAvailabilityProvider + Send + Sync + Debug + Clone,
{
    ...
    async fn system_config_by_number(
        ...
        info!("OraclePipeline system_config_by_number number={}", number);
