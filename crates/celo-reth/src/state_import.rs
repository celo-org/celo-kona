...
impl ImportCeloStateCommand {
    ...
    pub async fn execute(self) -> eyre::Result<()> {
        let chain = OpChainSpecParser::parse("celo")?;
        ...
        let env_args = EnvironmentArgs::<OpChainSpecParser> {
        ...
        let Environment { config, provider_factory, .. } = env_args.init::<OpNode>(AccessRights::RW)?;
